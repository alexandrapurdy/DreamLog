...
public class MenuToInputDreamSystemTest {
    ...
    @Test
    public void menu_inputDreamButton_navigatesToInputDreamScreen() {
        try (ActivityScenario<?> scenario = ActivityScenario.launch(
            ...
            waitForViewInHierarchy(UI_TIMEOUT_MS, withId(R.id.welcome));
            ...
            waitForViewInHierarchy(UI_TIMEOUT_MS, withId(R.id.doneButton));
        }
    }
